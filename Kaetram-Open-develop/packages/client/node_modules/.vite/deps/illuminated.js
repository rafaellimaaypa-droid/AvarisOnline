...
// ../../node_modules/illuminated/dist/illuminated.mjs
var P = (c, t, s) => {
  if (!t.has(c))
    throw TypeError("Cannot " + s);
};
var p = (c, t, s) => (P(c, t, "read from private field"), s ? s.call(c) : t.get(c));
var b = (c, t, s) => {
  if (t.has(c))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(c) : t.set(c, s);
};
var w = (c, t, s, n) => (P(c, t, "write to private field"), n ? n.call(c, s) : t.set(c, s), s);
var q = (c, t, s, n) => ({
  set _(e) {
    w(c, t, e, s);
  },
...
var r = class _r {
   ...
   */
  sub(t) {
    return new _r(this.x - t.x, this.y - t.y);
  }
  /**
   ...
   */
  mul(t) {
    return new _r(this.x * t, this.y * t);
  }
  /**
  ...
  normalize() {
    ...
    return new _r(this.x / t || 0, this.y / t || 0);
  }
  /**
...
var Q = class extends z {
  ...
  cast(t, s, n) {
    ...
    t.beginPath(), A(t, [d, R, v, x, C, l], true), t.arc(e.x, e.y, i, M, M + Math.PI), t.fill();
  }
  /**
...
var G = class {
  ...
  constructor(t = {}) {
    ...
    this.position = s ?? new r(), this.distance = n ?? 100, this.diffuse = e ?? 0.8, this.samples = i ?? 1, this.hidden = o ?? false;
  }
  /**
...
E = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap();
var j;
var $;
var I;
...
var O = B;
j = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), b(O, j, 0);
var m;
var T;
var U = class {
  /**
